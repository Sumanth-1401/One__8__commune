                ...
                <Row xs={1} md={2} lg={3} className="g-4">
                    <Col>
                        <Card className='bg-light shadow p-1'>
                            ...
                            <Card.Body>
                                <Card.Title style={{ color: "red" }}><b>MAC BOOK PRO</b></Card.Title>
                                <Card.Text>
                                    <b style={{ fontSize: "15px" }}>Prize :</b><em style={{ fontSize: "15px" }}> 1,49,900.00</em>
                                    <br />
                                    <b style={{ fontSize: "15px" }}>Memory :</b><em style={{ fontSize: "15px" }}> 8GB RAM ,512GB SSD </em>
                                    <br />
                                    <b style={{ fontSize: "15px" }}>Processor:</b><em style={{ fontSize: "15px" }}> Apple M2 chip</em>
                                    <br />
                    ...
                    <Col>
                        <Card className='p-1 shadow bg-light'>
                            ...
                            <Card.Body>
                                <Card.Title style={{ color: "red" }}><b>MAC BOOK PRO 13</b></Card.Title>
                                <Card.Text>
                                <b style={{ fontSize: "15px" }}>Prize :</b><em style={{ fontSize: "15px" }}> 1,29,990</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Memory :</b><em style={{ fontSize: "15px" }}> 8GB RAM,256GB SSD </em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Processor :</b><em style={{ fontSize: "15px" }}> Apple M2 chip</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Rating :</b> <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                    ...
                    <Col>
                        <Card className='p-1 shadow bg-light'>
                            ...
                            <Card.Body>
                                <Card.Title style={{ color: "red" }}><b>MAC AIR 14 PRO</b></Card.Title>
                                <Card.Text>
                                    <b style={{ fontSize: "15px" }}>Price :</b><em style={{ fontSize: "15px" }}> 2,29,990.00</em>
                                    <br />
                                    <b style={{ fontSize: "15px" }}>Memory :</b><em style={{ fontSize: "15px" }}> 16GB RAM, 1TB SSD</em>
                                    <br />
                                    <b style={{ fontSize: "15px" }}>Processor :</b><em style={{ fontSize: "15px" }}> Apple M1 pro chip</em>
                                    <br />
                                    <b style={{ fontSize: "15px" }}>Rating :</b> <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                                    <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                                    <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                    ...
                    <Col>
                        <Card className="p-1 shadow bg-light">
                            ...
                            <Card.Body>
                                <Card.Title style={{ color: "red" }}><b>MAC BOOK AIR</b></Card.Title>
                                <Card.Text>
                                <b style={{ fontSize: "15px" }}>Price :</b><em style={{ fontSize: "15px" }}> 1,02,490.00</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Memory :</b><em style={{ fontSize: "15px" }}> 8GB RAM, 512GB SSD</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Processor :</b><em style={{ fontSize: "15px" }}> Apple M1 Chip</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Rating :</b> <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                                <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                                <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                    ...
                    <Col>
                        <Card className='shadow p-1 bg-light'>
                            ...
                            <Card.Body>
                                <Card.Title style={{ color: "red" }}><b>MAC BOOK AIR (2021)</b></Card.Title>
                                <Card.Text>
                                <b style={{ fontSize: "15px" }}>Price :</b><em style={{ fontSize: "15px" }}> 92,900.00</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Memory :</b><em style={{ fontSize: "15px" }}> 8GB RAM, 256GB SSD</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Processor :</b><em style={{ fontSize: "15px" }}> Apple M1 Chip</em>
                    ...
                    <Col>
                        <Card className='p-1 shadow bg-light'>
                            ...
                            <Card.Body>
                            <Card.Title style={{ color: "red" }}><b>MAC BOOK PRO-16 INCH</b></Card.Title>
                                <Card.Text>
                                <b style={{ fontSize: "15px" }}>Price :</b><em style={{ fontSize: "15px" }}> 1,73,999.00</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Memory :</b><em style={{ fontSize: "15px" }}> 8GB RAM, 512GB SSD</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Processor :</b><em style={{ fontSize: "15px" }}> M2 Chip</em>
                                <br />
                                <b style={{ fontSize: "15px" }}>Rating :</b> <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                                <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
                                <FontAwesomeIcon style={{ color: "orange" }} icon={faStar} size="1x"></FontAwesomeIcon>
